...
class auto_encoder(nn.Module):
    def __init__(self):
        ...
        self.decoder=nn.Sequential(nn.ConvTranspose2d(512,256,2, stride=2), nn.ReLU(), nn.ConvTranspose2d(256,64,2,stride=2), nn.ReLU(), nn.ConvTranspose2d(64,3,2, stride=2), nn.Softmax())
...
class small_auto_encoder(nn.Module):
    def __init__(self):
        ...
        self.decoder=nn.Sequential(nn.ConvTranspose2d(32,16,2, stride=2), nn.ReLU(), nn.ConvTranspose2d(16,3,2,stride=2), nn.Softmax())#, nn.ReLU(), nn.ConvTranspose2d(16,3,2, stride=2), nn.Softmax())
